...
public class ElasticSearchConsumer {
    ...
    public static RestHighLevelClient createClient(){
        ...
        String hostname = "kafka-twitter-2039470419.eu-west-1.bonsaisearch.net"; // localhost or bonsai url
        String username = "d67w3010zf"; // needed only for bonsai
        String password = "qzl7umf6fu"; // needed only for bonsai
